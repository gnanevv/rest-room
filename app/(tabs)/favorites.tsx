...
//           onPress: () => removeFavorite(restroom.id),
//           style: 'destructive',
//         },
//       ]
//     );
...
//       <LinearGradient
//         colors={
//           theme === 'light' ? ['#DC2626', '#EF4444'] : ['#7C3AED', '#8B5CF6']
//         }
//         style={styles.header}
//       >
...
//         <View style={styles.statItem}>
//           <Text style={[styles.statNumber, { color: colors.text }]}>
//             {favorites.reduce((sum, restroom) => sum + restroom.rating, 0) /
//               favorites.length || 0}
//           </Text>
//           <Text style={[styles.statLabel, { color: colors.textSecondary }]}>
//             Ср. рейтинг
...
//             {
//               favorites.filter(
//                 (restroom) => restroom.distance && restroom.distance <= 1
//               ).length
//             }
//           </Text>
//           <Text style={[styles.statLabel, { color: colors.textSecondary }]}>
